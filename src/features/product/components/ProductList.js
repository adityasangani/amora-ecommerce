...
export default function ProductList() {
  ...
  const handleFilter = (e, section, option) => {
    ...
    if(e.target.checked===true){
      ...
      newFilter[section.id].splice(index,1); //deleting that unchecked box from the array
    }
  ...
  return (
    <div className="bg-white">
      <div>
        ...
        <MobileFilter handleFilter={handleFilter} mobileFiltersOpen={mobileFiltersOpen} filters={filters}  setMobileFiltersOpen={setMobileFiltersOpen}></MobileFilter>
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                      {products.map((product) => (
                        <Link to={`/product-detail/${product.id}`} key={product.id}>
                          <div className="group relative border-solid border-2 p-2 border-gray-200 h-full">
                            ...
                            <div className="mt-4 flex justify-between">
                              <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                  <StarIcon className="w-4 h-4 mb-1 inline"></StarIcon>
