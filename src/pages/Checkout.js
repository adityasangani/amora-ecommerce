    ...
    <div className="mx-auto mt-12 bg-white max-w-7xl px-2 sm:px-2 lg:px-4">
        ...
        <div className="border-t border-gray-200 px-2 py-6 sm:px-2">
                        ...
                        <div 
                            ...
                            className="flex 
                            cursor-pointer
                            items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
                          >
                            Order Now
                          </div>
                        </div>
